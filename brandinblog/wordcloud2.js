...
//      hover: null,
      hover: function hello(a, b, evt) {if (a != undefined) document.body.style.cursor = "pointer";else document.body.style.cursor = "default";},
      click: function hello(a, b, evt) {
          if (a != undefined) {
